...
class CategoriaResourceIT {
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO).imagemPath(DEFAULT_IMAGEM_PATH);
        return categoria;
    }
    ...
    public static Categoria createUpdatedEntity(EntityManager em) {
        Categoria categoria = new Categoria().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).imagemPath(UPDATED_IMAGEM_PATH);
        return categoria;
    }
    ...
    void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getImagemPath()).isEqualTo(DEFAULT_IMAGEM_PATH);
    }
    ...
    void putNewCategoria() throws Exception {
        ...
        updatedCategoria.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).imagemPath(UPDATED_IMAGEM_PATH);
        ...
        assertThat(testCategoria.getImagemPath()).isEqualTo(UPDATED_IMAGEM_PATH);
    }
    ...
    void fullUpdateCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedCategoria.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).imagemPath(UPDATED_IMAGEM_PATH);
